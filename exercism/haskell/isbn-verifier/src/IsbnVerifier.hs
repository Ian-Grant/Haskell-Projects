...
isbnHelper2 0 x = (ord(head x)*10) + isbnHelper2 1 x
isbnHelper2 1 x
...
isbnHelper2 3 x
    | (x !! 2 /= '-') = (ord(x!!3)*7) + isbnHelper2 4 x
    | (x !! 2 == '-') = (ord(x!!4)*7) + isbnHelper2 4 x
isbnHelper2 4 x
    | (x !! 2 /= '-') = (ord(x!!4)*6) + isbnHelper2 5 x
    | (x !! 2 == '-') = (ord(x!!6)*6) + isbnHelper2 5 x
isbnHelper2 5 x
    | (x !! 2 /= '-') = (ord(x!!5)*5) + isbnHelper2 6 x
    | (x !! 2 == '-') = (ord(x!!7)*5) + isbnHelper2 6 x
isbnHelper2 6 x
    | (x !! 2 /= '-') = (ord(x!!6)*4) + isbnHelper2 7 x
    | (x !! 2 == '-') = (ord(x!!8)*4) + isbnHelper2 7 x
isbnHelper2 7 x
    | (x !! 2 /= '-') = (ord(x!!7)*3) + isbnHelper2 8 x
    | (x !! 2 == '-') = (ord(x!!9)*3) + isbnHelper2 8 x
isbnHelper2 8 x
    | (x !! 2 /= '-') = (ord(x!!8)*2) + isbnHelper2 9 x
    | (x !! 2 == '-') = (ord(x!!10)*2) + isbnHelper2 9 x
isbnHelper2 9 x
    | (last x == 'X') = 10
    | (x !! 2 /= '-')&&((last x /= 'X')) = (ord(x!!9)*1)
    | (x !! 2 == '-')&&((last x /= 'X')) = (ord(x!!12)*1)
-----------1st Iteration----------------------
isbnx :: String -> Bool
isbnx x
